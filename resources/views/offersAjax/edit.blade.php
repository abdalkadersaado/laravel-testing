        ...
        <br>
                ...
                @csrf
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="name_ar" value="{{$offer->name_ar}}" aria-describedby="emailHelp" placeholder="{{__('messages.Offer Name ar')}}">
                        @error('name_ar')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="name_en" value="{{$offer->name_en}}" aria-describedby="emailHelp" placeholder="{{__('messages.Offer Name en')}}">
                        @error('name_en')
                        <small class="form-text text-danger">{{$message}}</small>
                        @enderror
                    </div>
